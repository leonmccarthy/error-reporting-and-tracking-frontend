        ...
        {listAssignedErrors.map((value, key)=>{
            return(
                <div className='errorHolder'>
                    ...
                    <div className='stepsToComplete' key={key}>Steps required to solve the error: {value.stepsToComplete}</div>
                    <div className='stepsDone' key={key}>Steps done: {value.stepsDone}</div>
